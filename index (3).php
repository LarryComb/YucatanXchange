      ...
      function initialize() {
        ...
        <?php
          $types = Array(
              ...
              Array('health & wellness', 'Health & Wellness'),
          ...
          foreach($types as $type) {
            ...
            while($place = mysql_fetch_assoc($places)) {
              ...
              $place[hours] = htmlspecialchars_decode(addslashes(htmlspecialchars($place[hours])));
              $place[wifi] = htmlspecialchars_decode(addslashes(htmlspecialchars($place[wifi])));
              echo "
                markers.push(['".$place[title]."', '".$place[type]."', '".$place[lat]."', '".$place[lng]."', '".$place[description]."', '".$place[uri]."', '".$place[address]."','".$place[hours]."','".$place[wifi]."']);
        ...
        jQuery.each(markers, function(i, val) {
          ...
          google.maps.event.addListener(marker, 'click', function () {
            infowindow.setContent(
              ...
              + "<div class='marker_hours'>"+val[7]+"</div>"
              + "<div class='marker_wifi'>"+val[8]+"</div>"
            );
  ...
  <body>
    ...
    <div class="topbar" id="topbar">
      <div class="wrapper">
        ...
        <div class="left">
          ...
          <div class="buttons">
            <a href="#modal_info" class="btn btn-large btn-info" data-toggle="modal" alt="About this Map">
                <i class="icon-info-sign icon-white"></i>
                <span class="hint">About this Map</span>
            </a>
            <?php if($sg_enabled) { ?>
                <a href="#modal_add_choose" class="btn btn-large btn-success" data-toggle="modal" alt="Add Something">
                <i class="icon-plus-sign icon-white"></i>
                <span class="hint">Add Something</span>
                </a>
            <?php } else { ?>
                <a href="#modal_add" class="btn btn-large btn-success" data-toggle="modal" alt="Add Something">
                    <i class="icon-plus-sign icon-white"></i>
                    <span class="hint">Add Something</span>
                </a>
            <?php } ?>
        ...
        <div class="toggle-menu hide">
            <img src="images/menu_bar.png" width="32" />
        </div>
        <script>
    ...
    <div class="modal hide" id="modal_info">
      ...
      <div class="modal-body">
        <p>
          We built this map to connect and promote the Digital Nomadic community
          in our beloved Tulum. We've seeded the map but we need
          your help to keep it fresh. If you don't see your event, please
          <?php if($sg_enabled) { ?>
          ...
          <?php } ?>
          Let's put Tulum on the map together!
        </p>
        <p>
        Questions? Feedback? Connect with us: <a href="http://www.twitter.com/<?= $twitter['username'] ?>" target="_blank">@<?= $twitter['username'] ?></a>
        </p>
        <p>
          If you want to support the Tulum community by linking to this map from your website,
          here are some badges you might like to use. You can also grab the <a href="./images/badges/LA-icon_delete.ai">Tulum icon AI file</a>.
        </p>
        <ul class="badges">
          <li>
            <img src="./images/badges/badge1_delete.png" alt="">
          </li>
          <li>
            <img src="./images/badges/badge1_small_delete.png" alt="">
          </li>
          <li>
            <img src="./images/badges/badge2_delete.png" alt="">
          </li>
          <li>
            <img src="./images/badges/badge2_small_delete.png" alt="">
          </li>
        </ul>
        <p>
          ...
          Check out some <a target="_blank" href="http://www.represent.la">startup maps</a> built by other communities!
        </p>
      </div>
          ...
          <fieldset>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <p class="help-block">
                  Google Maps <b>Address or Plus Code from Google Maps<b> 
                </p>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <p class="help-block">
                  Should be your full URL with no trailing slash, e.g. "www.yoursite.com"
                </p>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              <label class="control-label" for="add_hours">Hours</label>
              <div class="controls">
                <input type="text" class="input-xlarge" id="add_hours" name="hours" maxlength="150">
                <p class="help-block">
                  Please add hours you are open or can be reached. 
                </p>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label" for="add_wifi">Wifi & Password</label>
              <div class="controls">
                <input type="text" class="input-xlarge" id="add_wifi" name="wifi" maxlength="150">
                <p class="help-block">
                  Please add Wifi & Password if known or enter ???
                </p>
              </div>
            </div>
          </fieldset>
    ...
    <script>
      ...
      $("#modal_addform").submit(function(event) {
        ...
        var $form = $( this ),
            ...
            hours = $form.find( '#add_hours' ).val(),
            wifi = $form.find( '#add_wifi' ).val(),
            url = $form.attr( 'action' );

        // send data and get results
        $.post( url, { owner_name: owner_name, owner_email: owner_email, title: title, type: type, address: address, uri: uri, description: description, hours: hours, wifi: wifi, },
          function( data ) {
